...

      {
        isSignedIn
          ? <div className='flex items-center gap-2 sm:gap-3'>
              {/* Credit Display Box */}
              <button onClick={() => navigate('/buy')} className='flex items-center gap-2 bg-purple-100 px-4 py-1.5 sm:px-7 sm:py-2.5 rounded-full hover:scale-105 transition-all duration-700'>
